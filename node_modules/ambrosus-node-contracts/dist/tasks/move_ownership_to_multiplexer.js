...
var MoveOwnershipToMultiplexerTask = function (_TaskBase) {
  (0, _inherits3.default)(MoveOwnershipToMultiplexerTask, _TaskBase);

  function MoveOwnershipToMultiplexerTask(adminActions) {
    (0, _classCallCheck3.default)(this, MoveOwnershipToMultiplexerTask);

    var _this = (0, _possibleConstructorReturn3.default)(this, (MoveOwnershipToMultiplexerTask.__proto__ || Object.getPrototypeOf(MoveOwnershipToMultiplexerTask)).call(this));

    _this.adminActions = adminActions;
    return _this;
  }

  (0, _createClass3.default)(MoveOwnershipToMultiplexerTask, [{
    key: 'execute',
    value: function () {
        ...
        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                return _context2.abrupt('return', this.adminActions.moveOwnershipsToMultiplexer(newOwnerAddress));
  ...
  return MoveOwnershipToMultiplexerTask;
}(_task_base2.default);

exports.default = MoveOwnershipToMultiplexerTask;